...
for any number $0<t<\frac{\pi}{2}$ so that $x$ and $y$ are positive. The area to maximize is

\[\frac{1}{2}(2x+4x)y=3xy\]

Hence, we maximize $3\sin t\cos t$ for $0<t<\frac{\pi}{2}$ . 
