...
1 Problem
2 Solution 1
2.1 Option 1: Knowledge
2.2 Option 2: Angle Identities
3 Solution 2
4 Solution 3
5 Solution 4
6 Supplement (Calculating sin54/cos36 from Scratch)
...
\[tan(180^{\circ}) = \frac{5tan(36^{\circ})-10tan^3(36^{\circ})+tan^5(36^{\circ})}{1-10tan^2(36^{\circ})+5tan^4(36^{\circ})}\]

Now let $y = tan(36^{\circ})$ . We have the equation

\[\frac{5y-10y^3+y^5}{1-10y^2+5y^4} = 0 \implies 5y-10y^3+y^5 = 0\]

\[\implies 5-10y^2+y^4 = 0 \implies 5-10z+z^2 = 0\]

Where we let $z = y^2$ . Using the quadratic formula, we have

\[z = \frac{10 \pm \sqrt{80}}{2} = 5 \pm 2\sqrt{5}\]
