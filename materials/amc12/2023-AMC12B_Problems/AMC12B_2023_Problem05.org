...
3 Solution 2
4 Solution 3
5 Solution 4 (Checkerboard)
6 Solution 5 (Logic)
7 Solution 6 (Very Fast)
8 Video Solution by Math-X (First understand the problem!!!)
9 Video Solution 1 by MegaMath
10 Video Solution 2 by OmegaLearn
11 Video Solution
...
[asy] /* Diagram by MRENTHUSIASM */ import olympiad; unitsize(25); fill((1,2)--(1,3)--(2,3)--(2,2)--cycle, mediumgray); fill((1,0)--(1,1)--(2,1)--(2,0)--cycle, mediumgray); fill((2,1)--(2,2)--(3,2)--(3,1)--cycle, mediumgray); fill((0,1)--(0,2)--(1,2)--(1,1)--cycle, mediumgray); for (int i = 0; i < 4; ++i) { draw((i,0)--(i,3)); draw((0,i)--(3,i)); } [/asy]
