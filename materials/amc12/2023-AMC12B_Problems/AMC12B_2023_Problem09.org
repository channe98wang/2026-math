...
2 Diagram
3 Solution 1
4 Solution 2 (Graphing)
5 Note
6 Solution 3 (Logic)
7 Solution 4
8 Solution 5 (Desperate)
9 Video Solution 1 by OmegaLearn
10 Video Solution 2 by MegaMath
11 Video Solution
12 See Also
Problem
...
noted in the above solution, each square has a diagonal $2$ for an area of $\frac{2^2}{2} = 2$ , so the total area is $4\cdot2 =$ $\boxed{\text{(B) 8}}.$
~ Brian__Liu
Note
