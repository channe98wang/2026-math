...
Contents
1 Problem
2 Solution 1 (algebraic manipulation)
3 Solution 2 (Vieta's)
4 Solution 3 (Newton's Sums)
5 Solution 4 (Cheese Method)
6 Video Solution 1 (FAST)
7 Video Solution 2 by OmegaLearn
...
Same formal process of Solution 2, once we have $4x^3 - 13x^2 + 11x - 2$ . Let $s_{2} = a^2 + b^2 + c^2$ and $s_{1} = a + b + c = \frac{13}{4}$ . Applying Newton's Sums , we have

\[(4)s_{2} + (-13)s_{1} + 2 * 11 = 0\]

. We can solve that $s_{2} = \frac{81}{16}$ , and the interior diagonal would be
