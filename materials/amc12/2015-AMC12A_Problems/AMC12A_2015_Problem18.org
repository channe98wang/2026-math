...
\[x = \frac{a \pm \sqrt{a(a-8)}}{2}\]

. For $x$ to be an integer, it is necessary (and sufficient!) that $a(a-8)$ to be a perfect square. So we have $a(a-8) = b^2$ ; this is a quadratic in itself and the quadratic formula gives
