...
4 Solution 3 (Descartes' Theorem)
...
\[k_3 = k_1 + k_2 + 2\sqrt{k_1k_2}\]

(here, we take + instead of $\pm$ because we assume circle 3 has the smallest radius, and therefore the largest $k$ value.)
