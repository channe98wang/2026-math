...
2.3 Solution 3
2.4 Solution 4
2.5 Solution 5 (nonrigorous + abusing answer choices.)
2.6 Solution 6 (super quick)
2.7 Solution 7 (Not rigorous but it works)
2.8 Solution 8 (Assumption)
3 = Solution 9 (i just lost my dawg)
