...
2 Solution 1
3 Solution 2
4 Video Solution 1 by SpreadTheMathLove
5 Video Solution 2 by OmegaLearn.org
6 See Also
Problem
...
\[|z|=\frac{1}{4}|2+e^{i\theta}|=\frac{1}{4}\sqrt{5+4\cos\theta}\le\frac{3}{4}\]
