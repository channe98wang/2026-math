...
\begin{align*} (\log_2\tfrac{x}{y})^2&=(\log_2 x - \log_2 y)^2\\ &=(k-\tfrac{4}{k})^2=(3 \pm \sqrt{5} - \tfrac{4}{3 \pm \sqrt{5}})^2 \\ &= (3 \pm \sqrt{5} - [3 \pm \sqrt{5}])^2\\ &= (3 \pm \sqrt{5} - 3 \pm \sqrt{5})^2\\ &=(\pm 2\sqrt{5})^2 \\ &= \boxed{\textbf{(B) } 20}. \\ \end{align*}
