...
6 Solution 5
7 Solution 6
8 Solution 7 (Right Triangle Altitude Theorem)
9 See Also
Problem
...
Let $CA=x$ , and $CB=y$ . Looking at the figure, its trivial that the points $Z$ , $C$ , $A$ are concurrent. Construct line $ZB$ . By the right triangle altitude theorem, we have:
