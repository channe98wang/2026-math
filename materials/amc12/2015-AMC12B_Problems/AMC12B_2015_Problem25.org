...
and this is a $15-75-90$ triangle which has ratios of $1:(2+\sqrt3):(\sqrt2+\sqrt6)$ so the magnitude is $1008\sqrt2+1008\sqrt6$ and the answer is $1008+2+1008+6=\boxed{\text{(B) }2024}$ .
~caroline2023
Solution 6
