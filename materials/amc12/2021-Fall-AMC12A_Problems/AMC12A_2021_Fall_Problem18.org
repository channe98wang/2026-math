...
\[p=\frac{5\cdot4\cdot\binom{20}{3,5,4,4,4}}{5^{20}} \text{ and } q=\frac{\binom{20}{4,4,4,4,4}}{5^{20}}.\]

Therefore, the answer is

\[\frac pq=\frac{5\cdot4\cdot\binom{20}{3,5,4,4,4}}{\binom{20}{4,4,4,4,4}}=\frac{5\cdot4\cdot\frac{20!}{3!\cdot5!\cdot4!\cdot4!\cdot4!}}{\frac{20!}{4!\cdot4!\cdot4!\cdot4!\cdot4!}}=\frac{5\cdot4\cdot(4!\cdot4!\cdot4!\cdot4!\cdot4!)}{3!\cdot5!\cdot4!\cdot4!\cdot4!}=\frac{5\cdot4\cdot4}{5}=\boxed{\textbf{(E)}\ 16}.\]

~MRENTHUSIASM ~Jesshuang ~mathboy282
Solution 2
For simplicity purposes, we assume that the balls and the bins are both distinguishable.
...
\[p = \frac{80}{5}\cdot\frac{x}{a} = 16\cdot\frac{x}{a},\]

from which $\frac{p}{q} = \boxed{\textbf{(E)}\ 16}.$
~Hoju
