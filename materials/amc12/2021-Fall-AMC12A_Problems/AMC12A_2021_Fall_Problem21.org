...
3 Solution 2
4 Solution 3
5 Video Solution by The Power of Logic
6 Video Solution by Mathematical Dexterity
...
Hence, the slope of $BC$ is $m_{BC} = \frac{u}{2}$ .
The slope of $AD$ is $m_{AD} = \frac{v}{3}$ .
...
\begin{align*} {\rm Area} \ ABCD & = {\rm Area} \ \triangle ABC + {\rm Area} \ \triangle ADC \\ & = \frac{1}{2} AC \cdot BY + \frac{1}{2} AC \cdot DX \\ & = \frac{1}{2} AC \left( BY + DY \right) \\ & = 3 \sqrt{35} . \end{align*}
...
\[[ABCD]=[ABC]+[ADC]=\frac{1}{2}AC\cdot(BY+DX)=\frac{1}{2}\cdot6\cdot\sqrt{35}=\boxed{\textbf{(C)} \: 3\sqrt{35}}.\]
