...
\[k^2(r^2 - s^2)rs = 3(k(r^2 - s^2) + k(2rs) + k(r^2 + s^2)).\]
...
\[(k, r, s) = (1, 7, 1), (1, 5, 2), (1, 5, 3), (1, 7, 6), (2, 4, 1), (2, 4, 3), (3, 3, 1), (3, 3, 2), (6, 2, 1).\]

However, the ones where $r$ and $s$ are not different signs and relatively prime are redundant, so we get $6$ triples total.
See Also
