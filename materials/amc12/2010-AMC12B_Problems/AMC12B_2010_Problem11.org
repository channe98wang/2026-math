...
1 Problem
2 Solution 1
3 Solution (Divisibility Rules)
4 Addendum (Alternate)
5 Solution 4
6 Video Solution
7 See also
Problem
...
This nicely simplifies to the fact that $7 \mid 4b,$ so $b$ is clearly $0$ or $7$ . This gives us $9 \cdot 2$ total choices for the palindrome divisible by $7$ , divided by $9 \cdot 10$ total choices for $\overline{abba}$ , giving us an answer of $\boxed{\text{(E)}} \ \dfrac{1}{5}$ .
~icecreamrolls8
Addendum (Alternate)
