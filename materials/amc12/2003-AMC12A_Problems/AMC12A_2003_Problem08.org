...
\[60 = 1 \cdot 60 = 2 \cdot 30 = 3 \cdot 20 = 4 \cdot 15 = 5 \cdot 12 = 6 \cdot 10.\]

Hence $60$ has $12$ factors, of which $6$ are less than $7$ (namely, $1$ , $2$ , $3$ , $4$ , $5$ , and $6$ ), so the answer is $\frac{6}{12} = \boxed{\mathrm{(E)}\ \frac{1}{2}}$ .
Video Solution
