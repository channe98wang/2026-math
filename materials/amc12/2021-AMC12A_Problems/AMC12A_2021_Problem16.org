...
5 Solution 4 (Geometry)
6 Video Solution by Punxsutawney Phil
7 Video Solution by Hawk Math
8 Video Solution by Answer Choice
9 Video Solution by OmegaLearn (Using Algebra)
...
[asy]draw((0,0)--(200,200)--(200,0)--cycle); draw((142,0)--(142,142)); label("$x$",(142,0)--(142,142),E); label("$x$",(0,0)--(142,0),S); label("$200$",(200,0)--(200,200),E); [/asy]
