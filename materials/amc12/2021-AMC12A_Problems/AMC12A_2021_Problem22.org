...
- Solve for $a:$ By Vieta's Formulas, we have $a = - \left( \cos \frac{2\pi}7 + \cos \frac{4\pi}7 + \cos \frac{6\pi}7 \right).$
- Solve for $b:$ By Vieta's Formulas, we have $b = \cos \frac{2\pi}7 \cos \frac{4\pi}7 + \cos \frac{2\pi}7 \cos \frac{6\pi}7 + \cos \frac{4\pi}7 \cos \frac{6\pi}7.$
- Solve for $c:$ By Vieta's Formulas, we have $c = -\cos \frac{2\pi}7 \cos \frac{4\pi}7 \cos \frac{6\pi}7=-\cos \frac{2\pi}7 \cos \frac{4\pi}7 \cos \frac{8\pi}7.$
