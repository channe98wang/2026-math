...
\begin{align}\tag{2} \frac{2s}{\sqrt{3}}=\frac{v}{\sin(\theta-30^\circ)}=\frac {CD}{\cos\theta} \end{align}
 ...
 Now $BC=u+v=41(\sqrt{3}-1)$ . From $(1)$ and $(2)$ we get 
...
\[41(\sqrt{3}-1) = \frac{\sqrt{3}-1}{\sqrt{3}}(20\sqrt{3}+\sqrt{s^2-3\cdot 20^2})\]

which simplifies to

\[3\cdot 21^2 = s^2-3\cdot 20^2.\]

Since $(20, 21, 29)$ is a Pythagorean triple, we get $s=29\sqrt{3}$ , i.e. $\framebox{A}$ .
Solution 2
