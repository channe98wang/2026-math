...
1 Problem
2 Solution 1
3 Solution 2 (logical reasoning like solution 1, but a different train of thought)
4 Solution 3: Casework/Proof by contradiction
5 Video Solution by the Beauty of Math
6 See also
Problem
