...
Therefore, the given sum evaluates to

\[99=2(50)-1\implies 50^2=2500.\]

Since we're looking for the minimum possible sign changes, we focus on the largest numbers in the set to change to negative.
