...
2 Solution 1
3 Solution 2
4 Solution 3 (No Trig Manipulations)
5 Solution 4
...
\[OF = OC = OE = \frac{14\sqrt{3}}{3}.\]

We let $\angle FOC = \theta$ And $\angle EOC = 120 - \theta$
...
\[\sin(\theta/2)\sin(60^\circ - \theta/2) = \frac{3}{14}.\]
