...
11 Video Solution 3 by TheBeautyofMath
12 See also
Problem
...
\[1, 2.2, 3.2, 5.2, 6, 6.2, y, 7, z\]

We will use this diagram. Notice that $z$ has to be $8$ , and solving for $y$ yields $y=6.2$ , so we found our third and last triplet, $(6, 6.2, 8)$ , meaning that $\boxed{C}$ is the right answer.
~EaZ_Shadow
Solution 6 (Cheese）
