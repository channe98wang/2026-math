...
6 Solution 5 (Desperate)
7 China Test Solution (Finding )
8 Video Solution 1 by Pi Academy (Fast and Easy ⚡🚀)
9 Video Solution 2 by SpreadTheMathLove
10 Video Solution 3 by TheBeautyofMath
11 See also
Problem
...
^ To the person above:
Under the problem, there’s a note that says some tests in China asked for the area of $\triangle MAY$ . - trevian1
