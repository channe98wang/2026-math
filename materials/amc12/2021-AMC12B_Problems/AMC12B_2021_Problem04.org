...
\[\begin{array}{c|c|c|c} & & & \\ [-2.5ex] & \textbf{\# of Students} & \textbf{Mean} & \textbf{Total} \\ \hline & & & \\ [-2.5ex] \textbf{Morning} & m & 84 & 84m \\ \hline & & & \\ [-2.5ex] \textbf{Afternoon} & a & 70 & 70a \end{array}\]

We are also given that $\frac ma=\frac34,$ which rearranges as $m=\frac34a.$
The mean of the scores of all the students is

\[\frac{84m+70a}{m+a}=\frac{84\left(\frac34a\right)+70a}{\frac34a+a}=\frac{133a}{\frac74a}=133\cdot\frac47=\boxed{\textbf{(C)} ~76}.\]
