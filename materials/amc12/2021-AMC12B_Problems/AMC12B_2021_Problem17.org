...
2 Solution
3 Solution 2
4 Video Solution by Challenge 25
5 Video Solution (🚀 Just 3 min 🚀)
6 Video Solution by OmegaLearn (Triangle Ratio and Trapezoid Area)
7 See Also
Problem
...
Thus, $b_1h_1 = 8, b_2h_2 = 4, (b_1+b_2)(h_1+h_2) = 28,$ so $b_1h_2 + b_2h_1 = 16.$ Let $b_2 = 1, h_2 = 4,$ so we get $b_1h_1 = 8, 4b_1+h_1 = 16.$ This gives us a quadratic in $b_1,$ ie. $4b_1^2+8=16b_1,$ so $b_1 = \boxed{\textbf{(B)}\: 2+\sqrt{2}}.$
