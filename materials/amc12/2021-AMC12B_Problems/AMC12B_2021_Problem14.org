...
3 Solution 2
4 Solution 3
5 Video Solution (Fast! Just 4 min!)
6 Video Solution by Hawk Math
7 Video Solution by OmegaLearn (Pythagorean Theorem and Volume of Pyramid)
8 See Also
Problem
...
\[\frac13\cdot [ABCD]\cdot MD = \frac13\cdot (AD\cdot CD)\cdot MD = \boxed{\textbf{(A) }24\sqrt5}.\]
