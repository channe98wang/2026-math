...
3 Solution 2
4 Solution 3
5 Solution 4 (Funny Observations)
6 Solution 5
7 Solution 6
8 Video Solution by OmegaLearn (Using Complex Number Identities)
9 Video Solution
...
is satisfied for $z+\tfrac{6}{z}=-2$ , and the answer is $\boxed{\textbf{(A) }-2}$ .
Solution 6
