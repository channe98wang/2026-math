...
\[19\cdot 38\cdot 19 + \tfrac{1}{2}d\cdot 38\cdot\tfrac{1}{2}d=19r^{2}+19r^{2}.\]

This simplifies to $13718+\tfrac{19}{2}d^{2}=38r^{2}$ . Similarly, another round of Stewart's Theorem applied to $\triangle OEF$ with cevian $\overleftrightarrow{OQ}$ gives

\[17\cdot 34\cdot 17 + \tfrac{3}{2}d\cdot 34\cdot\tfrac{3}{2}d=17r^{2}+17r^{2}.\]

This simplifies to $9826+\tfrac{153}{2}d^{2}=34r^{2}$ . Dividing the top equation by $38$ and the bottom equation by $34$ results in the system of equations 
