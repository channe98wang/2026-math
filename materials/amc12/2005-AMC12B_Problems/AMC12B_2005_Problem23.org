...
\begin{align*} x^3+y^3&=10^{3z}-\frac{3}{2}(10^{2z}-10\cdot 10^z)(10^z) \\ &=10^{3z}-\frac{3}{2}(10^{3z}-10\cdot 10^{2z}) =-\frac{1}{2}10^{3z}+15\cdot 10^{2z}, \end{align*}

 and $a+b=-\frac{1}{2}+15=\boxed{29/2}$ .
