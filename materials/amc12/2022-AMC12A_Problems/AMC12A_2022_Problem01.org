...
\begin{align*} [3]&=3(1) = 3\\ [3,3]&=3(3)+1=10\\ [3,3,3]&=3(10)+3=33\\ [3,3,3,3]&=3(33)+10=109\\ \dfrac{[q_0,q_1,q_2,\ldots,q_n]}{[q_1,q_2,\ldots,q_n]}&=\dfrac{[3,3,3,3]}{[3,3,3]}\\ &=\boxed{\textbf{(D)}\ \frac{109}{33}} \end{align*}
