...
9 Solution 8 (Recursion)
10 Video Solution by Math-X (Smart and Simple)
11 Video Solution
12 Video Solution
13 Video Solution By OmegaLearn using Complementary Counting
14 See Also
Problem
...
\[N \left( p, q \right) = \sum_{i = 0}^{p - q} \binom{p}{i} N \left( p - i, q - 1 \right) , \ \forall \ p \geq q \mbox{ and } q \geq 1\]
