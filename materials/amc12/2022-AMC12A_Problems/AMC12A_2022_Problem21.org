...
3 Solution 2
4 Solution 3
5 Solution 4 (Describe the Roots)
6 Solution 5 (Simple Elimination)
6.1 Solution 5a (Elimination but slightly different)
6.2 Solution 5b (elimination but even faster and cheesier)
...
so Therefore, the answer is $\boxed{E}$ .
- DavidHovey
...
, the roots of $P$ are the $3033$ rd roots of unity that aren't $1011$ th roots of unity.
Now, note that:
