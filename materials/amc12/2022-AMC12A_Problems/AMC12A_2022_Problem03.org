...
Contents
1 Problem
2 Solution 1 (Area and Perimeter of Square)
3 Solution 2 (Perimeter of Square)
4 Solution 3 (Observations)
5 Solution 4 (Observations)
6 Video Solution (Creativity)
