...
1 Problem
2 Solution 1
3 Solution 2 (Formula of tanx)
4 Solution 3
5 Solution 4
6 Solution 5 (2 minutes, easy)
7 Video Solution 1 by OmegaLearn
8 Video Solution
9 See Also
Problem
...
Notice that $\tan 2x = \dfrac{2 \tan x}{1 - \tan^2 x}$ , and $\tan 3x = \dfrac{3 \tan x - \tan^3 x}{1-3 \tan^2 x}$ Since this is the AMC, conjecture that some pattern is to be found within the last term of the expansion of $\tan nx$ .
