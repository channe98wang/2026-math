...
\[RC = 100 - 3\sqrt{x^2 - 900}.\]

We also realize that $RS = 120 - 3x$ , so this means that:

\[\cos\theta = \frac{100 - 3\sqrt{x^2 - 900}}{120 - 3x}.\]

We can then substitute $x = \frac{30}{\sin\theta}$ , so this gives: 
...
\[\cos\theta = \frac{10\sin\theta - 9\cos\theta}{12\sin\theta - 9},\]

meaning that:

\[12\sin\theta\cos\theta - 9\cos\theta = 10\sin\theta - 9\cos\theta \implies \cos\theta = \frac{10}{12} = \frac56.\]
