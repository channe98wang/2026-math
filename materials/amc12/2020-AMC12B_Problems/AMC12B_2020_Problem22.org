...
\[R = - 3t^24^{-t} + t2^{-t}= - 3u^2 + u = - 3 (u - 1/6)^2 + \frac{1}{12} \le \frac{1}{12} .\]

It is easy to see that $u =\frac{1}{6}$ is attained for some value of $t$ between $t = 0$ and $t = 1$ , thus the maximal value of $R$ is $\textbf{(C)}\ \frac{1}{12}$ .
...
\[\frac{(2^t-3t)t}{4^t} = m \implies m2^{2t} - t2^t + 3t^2 = 0.\]

Solving for $2^{t}$ , we see

\[2^{t} = \frac{t}{2m} \pm \frac{\sqrt{t^2 - 12mt^2}}{2m} = \frac{t}{2m} \pm \frac{t\sqrt{1 - 12m}}{2m}.\]

We see that $1 - 12m \geq 0 \implies m \leq \frac{1}{12}.$ Therefore, the answer is $\boxed{\textbf{(C)}\ \frac{1}{12}}$ .
Solution 6
Let $z=2^t.$ Then,
