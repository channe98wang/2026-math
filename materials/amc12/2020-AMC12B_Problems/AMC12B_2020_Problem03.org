...
\[\frac wy = \frac wx \cdot \frac xz \cdot \frac zy = \frac43\cdot\frac61\cdot\frac23=\frac{16}{3},\]

from which $w:y=\boxed{\textbf{(E)}\ 16:3}.$
~MRENTHUSIASM
Solution 2
...
We begin by multiplying both sides of $2y = 3z$ by two, obtaining $4y = 6z$ . We then substitute that into $6z = x$ to get $4y = x$ . Now, to be able to substitute this into out first equation, we need to have $4x$ on the RHS. 
