...
3 Solution 2
4 Solution 3
5 Video Solution by MistyMathMusic
6 See Also
Problem
...
\[x_4=\left( \frac{-1+i\sqrt{3}}{2} \right) ^3 r=r,\]

which means $x_4$ is the same as $x_1$ .
...
\[x_6=\left( \frac{-1+i\sqrt{3}}{2} \right) ^3 p=p,\]

different from all known roots. We get 6 different roots for the polynomial, which contradicts the limit of 5 roots. Therefore the assumption of a different root is wrong, thus the roots must be chosen from $x_1$ , $x_2$ , and $x_3$ .
