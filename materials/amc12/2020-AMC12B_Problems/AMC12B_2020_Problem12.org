...
\[CE^2-DE^2-(CE)(OE)\sqrt{2}-(DE)(OE)\sqrt{2}=0.\]
...
\[CM^2 = 50 - x^2 = 50 - (35 - 10\sqrt{10}) = 15 + 10 \sqrt{10}\]
...
circle $(x + a)^2 + y^2 = r^2$ intersects line y = -x at 2 points $C(X_c, Y_c)$ and $D(X_d, Y_d)$ $X_c = -Y_c$ , $X_d = -Y_d$
