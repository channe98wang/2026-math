...
Solution 3
Like in Solution 2 , calculate the first few terms of the sequence, but also keep a running sum $c_n$ of the logarithms (not modulo $19$ here):
...
$c_n$ is first a multiple of $19$ at $n = \boxed{\textbf{(A)}\ 17}$ . ~ emerald_block
