...
7 Solution 6
8 Video Solution
9 Video Solution by CanadaMath (Problem 11-20)
10 See Also
Problem 16
...
Now we know that, $y+x$ and $y-x+1$ multiply together to $690$ , and they're both integers. Now, we can set $y+x$ and $y-x+1$ equal to factors of $690$ . Clearly, $x>\frac{1}{2},$ so $y+x$ will take the larger of the two factors.
