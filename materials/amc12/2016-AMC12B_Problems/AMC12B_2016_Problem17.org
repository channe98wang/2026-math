...
5 Solution 4
6 Video Solution
7 Video Solution by CanadaMath (Problem 11-20)
8 See Also
Problem
...
Apply the Angle Bisector Theorem on $\triangle ACH$ and $\triangle ABH$ , we get $AP:PH = 9:6$ and $AQ:QH = 7:2$ , respectively.
...
Subtracting the prior from the latter yields $-16x+64=32\implies x=2$ . So, $BH=2$ , $CH=6$ , and $AH=3\sqrt{5}$ . Continue with Solution 1.
Video Solution
