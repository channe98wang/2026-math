...
[asy] path b = brace((0,10),(90,10),5); draw(b); label("$90^\circ$",b,N); draw("$5x$",(0,0)--(75,0),N); draw((75,2.5)--(75,-2.5)); draw("$1y$",(75,0)--(90,0),N); draw("$4x$",(0,-10)--(60,-10),S); draw((60,-7.5)--(60,-12.5)); draw("$2y$",(60,-10)--(90,-10),S); draw((0,5)--(0,-15)); draw((90,5)--(90,-15)); [/asy]

\[5x+1y = 90^\circ = 4x+2y\]

Moving like terms to the same side gets $x = y$ , and substituting this back gets $6x = 90^\circ \implies x = \frac{90^\circ}{6} = 15^\circ$ , so the sum of the degree measures is $5x + 4x = 9x = 9(15) = \boxed{\textbf{(C)}\ 135}$ . ~ emerald_block
See Also
