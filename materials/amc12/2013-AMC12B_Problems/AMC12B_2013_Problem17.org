...
2 Solution 1
3 Solution 2
4 Solution 3 (no Cauchy-Schwarz)
5 Solution 4 (geometrical approach)
6 Solution 5
7 Solution 6
8 Solution 7
9 See also
...
Substitution of the above results and some algebra yields

\[3c^2 - 4c - 20 \leq 0\]

This quadratic inequality is easily solved, and it is seen that equality holds for $c = -2$ and $c = \frac{10}{3}$ .
...
Solving this, we get the quadratic

\[3c^2-4c+4=24 \Rightarrow c=\frac{10}{3}, -2\]
...
\[\begin{cases} a+b=2-c\\ ab=c^2-2c-4\\ \end{cases}\]

We can reverse Vieta's Formulas , to get that $a$ and $b$ are roots of the quadratic equation(in $x$ )

\[x^2-(2-c)x+(c^2-2c-4).\]

Because we have $a, b\in \mathbb{R}$ , we have that the discriminant of this quadratic equation must be nonnegative. The discriminant is

\[(2-c)^2-4(c^2-2c-4)=-3c^2+4c+20,\]
