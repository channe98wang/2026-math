...
\[N=5a_1+8a_2=5b_1+8b_2\]

or

\[5a_1+8a_2=5(a_1+c)+8(a_2-d)\]

for some natural numbers $c$ , $d$ . Thus $5c=8d$ . To minimize $c$ and $d$ , we have $(c,d)=(8,5)$ , or

\[5a_1+8a_2=5(a_1+8)+8(a_2-5).\]

To minimize $a_1$ and $b_1$ , we have $(a_1,b_1)=(0,0+c)=(0,8)$ . Using the same method, since $b_2\ge b_1$ , we have $b_2\ge8$ .
