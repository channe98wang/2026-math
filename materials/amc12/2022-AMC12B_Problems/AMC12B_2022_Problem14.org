...
1 Problem
2 Diagram
3 Solution 1 (Dot Product)
4 Solution 2
5 Solution 3
6 Solution 4
7 Solution 5
8 Solution 6 (Complex Numbers)
...
\[\cos(\angle ABC) = \frac{AB^2 + BC^2 - AC^2}{2 AB BC} = \frac{250 + 234 - 64}{30 \sqrt{260}} = \frac{7}{\sqrt{65}}.\]

Then, we use the identity $\tan^2(x) = \sec^2(x) - 1$ to get
...
\[\frac12\cdot8\cdot15=\frac12\cdot5\sqrt{10}\cdot3\sqrt{26}\cdot\sin{B},\]
