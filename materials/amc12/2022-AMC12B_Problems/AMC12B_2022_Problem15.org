...
7 Solution 4 (modulo 15 elimination)
8 Video Solution by mop 2024
9 Video Solution
10 Video Solution by OmegaLearn Using Digit Cycles
...
\begin{align*} 2^{606} + 1 & \equiv 2^{{\rm Rem} ( 606, \phi(5) )} + 1 \\ & \equiv 2^{{\rm Rem} ( 606, 4 )} + 1 \\ & \equiv 2^2 + 1 \\ & \equiv 0 . \end{align*}
...
\begin{alignat*}{8} 2^{606}-1 &= 4^{303}-1 &&= (4-1)(4^{302}+4^{301}+4^{300}+\cdots+4^0), \\ 2^{606}+1 &= 4^{303}+1 &&= (4+1)(4^{302}-4^{301}+4^{300}-\cdots+4^0), \\ 2^{607}+1 & &&= (2+1)(2^{606}-2^{605}+2^{604}-\cdots+2^0), \\ 2^{607}+3^{607} & &&= (2+3)(2^{606}\cdot3^0-2^{605}\cdot3^1+2^{604}\cdot3^2-\cdots+2^0\cdot3^{606}). \end{alignat*}
