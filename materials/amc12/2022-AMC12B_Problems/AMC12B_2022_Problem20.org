...
9 Solution 8
10 Solution 9
11 Solution 10 (EZ CRT)
12 Video Solution
13 Video Solution
14 Video Solution by OmegaLearn Using Polynomial Remainders
15 Video Solution by The Power of Logic(#20-#21)
...
Letting $x=1,$ we conclude that $r=-2,$ so $R(x)=x+2.$ Therefore,
