...
\[\frac{\sin(36)+\sin(56)}{\cos(36)-\cos(56)}\]

Now, using sum to product identities, we have this equal to

\[\frac{2\sin(46)\cos(10)}{-2\sin(46)\sin({-10})}=\frac{\sin(80)}{\cos(80)}=\tan(80)\]
...
\[\angle XAM = 90 - \angle MXA = 90 - \frac{\angle AXP}{2} = 90 - \frac{\angle ATP}{2}= 90 - 44 = 46,\]

giving $\angle XMN = \angle XAG = 56 - 46 = 10$ as desired.
Solution 7 (Olympiad Nuke)
By https://artofproblemsolving.com/community/c6h489748p2745891 , we get that $MN$ is parallel to the angle bisector of $\angle ATP.$ Thus,
