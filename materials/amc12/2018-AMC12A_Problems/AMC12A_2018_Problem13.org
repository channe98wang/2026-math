...
5 Solution 4
6 Solution 5 (Casework and Recursion)
7 Solution 6
8 Solution 7
9 Solution 8
10 Solution 9
11 Solution 10
12 Solution 11 (2 seconds)
13 Video Solution by Pi Academy (FAST and easy)
14 Video Solution
15 See Also
Problem
...
to be negative. Therefore, if $a_7$ is 1, there are $3^7=2187$ possibilities. (We also must convince ourselves that these $2187$ different sets of coefficients must necessarily yield $2187$ different integer results.)
