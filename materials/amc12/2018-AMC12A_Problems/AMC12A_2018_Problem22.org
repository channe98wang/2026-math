...
Contents
1 Problem
2 Solution 1 (Complex Numbers in Rectangular Form)
3 Solution 2 (Complex Numbers in Polar Form)
4 Solution 3 (Vectors)
5 Solution 4 (Vectors)
6 Solution 5 (Shoelace, Similar to Solution 1)
...
\[\frac{1}{2} \left|(x_1y_2 + x_2y_3 + x_3y_4 + x_4y_1) - (y_1x_2 + y_2x_3 + y_3x_4 + y_4x_1)\right| = 6\sqrt2-2\sqrt{10},\]

so the answer is $6+2+2+10=\boxed{\textbf{(A) } 20}.$
~Rejas ~MRENTHUSIASM
Solution 2 (Complex Numbers in Polar Form)
We solve each equation separately:
- $z^2=4+4\sqrt{15}i$ The solutions to $z^2=4+4\sqrt{15}i$ are $\boldsymbol{z=\sqrt{10}+\sqrt{6}i,-\sqrt{10}-\sqrt{6}i}.$
- $z^2=2+2\sqrt 3i,$
