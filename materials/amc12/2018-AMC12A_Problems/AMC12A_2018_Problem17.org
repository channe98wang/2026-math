...
\[\frac{[\text{Field}]-[S]}{[\text{Field}]}=\frac{6-x^2}{6}=\boxed{\textbf{(D) } \frac{145}{147}}.\]
...
\[x^2+\dfrac{x(3-x)}{2}+\dfrac{x(4-x)}{2}+5=6.\]
...
We name small triangle the triangle similar to given in which unplanted square $S$ is inscribed.
