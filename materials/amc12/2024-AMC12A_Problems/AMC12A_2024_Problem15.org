...
3 Solution 2
4 Solution 3
5 Solution 4 (Newton's Sums and Vieta's)
6 Solution 5 (Reduction of power)
7 Solution 6 (Cheesing it out)
8 Solution 7
9 Video Solution, Fast, Quick, Easy!
10 See also
Problem
...
We find that $f(2i)=-8i-8-2i+3=-10i-5$ and $f(-2i)=8i-8+2i+3=10i-5$ , so

\[f(2i)f(-2i)=(-5-10i)(-5+10i)=(-5)^2-(10i)^2=25+100=\boxed{\textbf{(D) }125}.\]

~eevee9406
Solution 3
First, denote that

\[p+q+r=-2, pq+pr+qr=-1, pqr=-3\]
