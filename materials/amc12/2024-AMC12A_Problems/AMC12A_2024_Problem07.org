...
Contents
1 Problem
2 Solution 1 (technical vector bash)
3 Solution 2
4 Solution 3 (Pair Sum)
5 Solution 4
6 Solution 5 (Physics-Inspired)
7 Solution 6 (Complex Number)
8 Solution 7 (Extreme Case)
9 Video Solution 1 (⚡️3 min solve⚡️)
10 See also
Problem
...
\[\left|\overrightarrow{BP_1}+\overrightarrow{BP_2 }+ ...+\overrightarrow{BP_{2024}}\right|=2 \cdot 1012=\fbox{(D) 2024}\]
