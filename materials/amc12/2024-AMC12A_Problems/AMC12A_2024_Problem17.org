...
2 Solution 1
3 Solution 2
4 Solution 3 (Guess and check)
5 Solution 4
6 Solution 5
7 Solution 6 (Elimination)
8 Video Solution by STEM Station(Quick and Easy to Understand!)
9 Video Solution, Fast, Quick, Easy! Simple Factoring Technique
...
So, the correct answer is: $ab+ba+ac= -9\cdot-12+-12\cdot-8+-8\cdot-9 = \boxed{\textbf{(D) }276}.$
~pimathmonkey
