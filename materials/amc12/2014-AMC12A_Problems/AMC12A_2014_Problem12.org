...
5 Solution 4
6 Solution 5
7 Solution 6 (using answer choices)
8 Video Solution
9 See Also
Problem
...
\[\left(\dfrac {x}{y} \right)^2 = \left(\dfrac{\dfrac{1}{2}}{\dfrac{\sqrt{6} - \sqrt{2}}{4}} \right)^2 = \left(\dfrac{\sqrt{6} + \sqrt{2}}{2} \right)^2 = 2 + \sqrt{3} =\boxed{\textbf{(D)}}\]
