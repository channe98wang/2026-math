...
2 Solution 1
3 Solution 2
4 Video Solution by Richard Rusczyk
5 See Also
Problem
The fraction
...
\[\sum^{\infty}_{n=1}\dfrac{1}{10^{2n}}\]

.
similarly the fraction $\dfrac{1}{99^2}$ can be written as $\sum^{\infty}_{m=1}\dfrac{1}{10^{2m}}\sum^{\infty}_{n=1}\dfrac{1}{10^{2n}}$ which is equivalent to

\[\sum^{\infty}_{m=1}\sum^{\infty}_{n=1} \dfrac{1}{10^{2(m+n)}}\]
...
we note that the sequence starts repeating at $k = 102$ yet consider

\[\sum^{101}_{k=99}\dfrac{k-1}{10^{2k}}=\dfrac{98}{{10^{198}}}+\dfrac{99}{{10^{200}}}+\dfrac{100}{10^{{202}}}=\dfrac{1}{10^{198}}(98+\dfrac{99}{100}+\dfrac{100}{10000})=\dfrac{1}{10^{198}}(98+\dfrac{99}{100}+\dfrac{1}{100})=\dfrac{1}{10^{198}}(98+\dfrac{100}{100})=\dfrac{1}{10^{198}}(99)\]
