...
2 Solution
3 Solution 2
4 Solution 3 (think about it a lil bit)
5 See also
Problem
...
Solution 2
[asy] import graph; import patterns; unitsize(1cm); add("tile",tile()); add("checker",checker()); filldraw((-3,2)--(3,2)--(3,-2)--(-3,-2)--cycle,pattern("checker")); filldraw((-3,2)--(-3,7)--(3,7)--(3,2)--cycle,pattern("tile")); filldraw((-3,-2)--(-3,-7)--(3,-7)--(3,-2)--cycle,pattern("tile")); filldraw((-8,2)--(-3,2)--(-3,-2)--(-8,-2)--cycle,pattern("tile")); filldraw((8,2)--(3,2)--(3,-2)--(8,-2)--cycle,pattern("tile")); draw((8,2)--(3,7)--(-3,7)--(-8,2)--(-8,-2)--(-3,-7)--(3,-7)--(8,-2)--cycle,blue); xaxis(-9,9,Ticks(NoZero,Step=1)); yaxis(-8,8,Ticks(NoZero,Step=1)); dot((-3,2));label("$A$",(-3,2),N); dot((3,-2));label("$B$",(3,-2),N); // Asymptote by Technodoggo; August 16, 2024 [/asy]
