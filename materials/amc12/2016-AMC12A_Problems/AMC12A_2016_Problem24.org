...
Contents
1 Problem
2 Solution 1 (calculus)
3 Solution 2
4 Solution 3 (SUPER RISKY) do if you have no time
5 Solution 3.5(SUPER TECHNICAL)
6 Video Solution by the Art of Problem Solving
7 See Also
Problem
...
\[\tfrac 13 (r+s+t) \ge \sqrt[3]{rst} \quad \Rightarrow \quad a \ge 3\sqrt[3]{a}.\]

Cubing both sides and then dividing by $a$ (since $a$ is positive we can divide by $a$ and not change the sign of the inequality) yields

\[a^2 \ge 27 \quad \Rightarrow \quad a \ge 3\sqrt{3}.\]
