...
We rewrite them in the simplest form:

\[\frac{1}{14},\frac{2}{13},\frac{1}{4},\frac{4}{11},\frac{1}{2},\frac{2}{3},\frac{7}{8},1\frac{1}{7},1\frac{1}{2},2,2\frac{3}{4},4,6\frac{1}{2},14.\]
...
\[\frac ab = \frac{15-b}{b} = \frac{15}{b}-1.\]

We can ignore the $-1$ part and only focus on $\frac{15}{b}.$
