...
3 Solution 1
4 Solution 2
5 Solution 3 (Analytic Geometry)
6 Solution 4
7 Solution 5
8 Video Solution
...
Let lines $OB$ and $AP$ intersect at point $D$ .
Hence, $ACBD$ is a rectangle.
Denote by $M$ the midpoint of segment $AB$ . Hence, $BM = \frac{AB}{2} = 5$ .
Because $O$ and $P$ are on the perpendicular bisector of segment $AB$ , points $M$ , $O$ , $P$ are collinear with $OM \perp AB$ .
We have $\triangle MOB \sim \triangle CBA$ .
Hence, $\frac{BO}{AB} = \frac{BM}{AC}$ .
Hence, $BO = \frac{25}{4}$ .
Hence, $OD = BD - BO = \frac{7}{4}$ .
We have $\triangle DOP \sim \triangle CBA$ .
Hence, $\frac{OP}{BA} = \frac{DO}{CB}$ .
Therefore, $OP = \frac{35}{12}$ .
