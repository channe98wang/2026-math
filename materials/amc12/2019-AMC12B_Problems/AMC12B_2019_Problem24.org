...
[asy] size(100,100); draw((-2,0)--(2,0), gray); draw((0,-2)--(0,2), gray); draw((0,0)--(1,0), red); [/asy]
When $a=0, b=1$ we have $-\frac{1}{2}, \frac{\sqrt{3}}{2}$ : 

[asy] size(100,100); draw((-2,0)--(2,0), gray); draw((0,-2)--(0,2), gray); draw((0,0)--(-1/2,sqrt(3)/2), red); draw((0,0)--(1,0), red); [/asy]
When $a=1, b=1$ we have $\frac{1}{2}, \frac{\sqrt{3}}{2}$ : 

[asy] size(100,100); draw((-2,0)--(2,0), gray); draw((0,-2)--(0,2), gray); draw((0,0)--(-1/2,sqrt(3)/2), red); draw((0,0)--(1,0), red); draw((-1/2,sqrt(3)/2)--(1/2,sqrt(3)/2), red); draw((1,0)--(1/2,sqrt(3)/2), red); [/asy]
