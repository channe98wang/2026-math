...
We can now divide both sides by 11 in our original equation $7x^5=11y^{13}$ to get $y^{13}=7^{5c+1}11^{5d-1}$ . As we are only considering integers, we have

\[5c+1\equiv0~(\text{mod}~13)\implies5c\equiv12~(\text{mod}~13)\]
