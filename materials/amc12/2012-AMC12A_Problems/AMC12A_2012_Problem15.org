...
There is exactly $1$ way to color the grid this way. 
 Case 2: 1 white square.
Note that the white square can be anywhere on the grid except for the middle square because when rotating 90 degrees it can never land on itself. Thus, there are $8$ cases. 
...
Thus, we have $56-(48-8)=16$ ways in this case. 
