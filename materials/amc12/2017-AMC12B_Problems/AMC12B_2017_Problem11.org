...
4 Solution 3
5 Solution 4
6 Solution 5 (Casework / 1-1 Correspondence)
7 See Also
Problem
...
\[2 \cdot (2^9 - 1) = 2 \cdot 511 = 1022\]

possibilities. Note that we subtracted out the $1$ because we cannot choose none of the numbers.
