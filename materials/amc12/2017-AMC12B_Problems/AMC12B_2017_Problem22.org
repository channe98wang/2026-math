...
2 Solution 1
2.1 Remark
3 Solution 2 (Less Casework)
4 Solution 3
5 Solution 4
5.1 Visualization of three cases
6 Solution 5 (Casework/Inspired by states)
7 See Also
Problem
...
\[\begin{bmatrix} & A & B & \\ & B & C & \\ & C & D & \\ & A & D & \\ \end{bmatrix}\]
...
Now we divide this by the total number of ways: $(4\cdot3)^4$ (four rounds, four ways to choose giver, three to choose receiver each round).
