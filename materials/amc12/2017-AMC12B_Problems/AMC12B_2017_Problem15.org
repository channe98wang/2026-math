...
4 Solution 2
5 Solution 3
6 Solution 4 (Elimination and Educated Guess)
...
Let $AB=BC=CA=x$ .
Recall The Law of Cosines. Letting $A'B'=B'C'=C'A'=y$ ,

\[y^2=(3x)^2+(x+3x)^2-2(3x)(x+3x)(\cos 120) =\]

\[(3x)^2+(4x)^2-2(3x)(4x)(\cos 120)=9x^2+16x^2-24x(\cos 120)=25x^2+12x^2=37x^2.\]

Since both $\triangle ABC$ and $\triangle A'B'C'$ are both equilateral triangles, they must be similar due to $AA$ similarity. This means that $\frac{A'B'}{AB}$ $=$ $\frac{B'C'}{BC}$ $=$ $\frac{C'A'}{CA}$ $=$ $\frac{[\triangle A'B'C']}{[\triangle ABC]}$ $=$ $\frac{37}{1}$ .
