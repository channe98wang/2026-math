...
4 Solution 3
5 Solution 4 (Cheap)
6 Solution 5 (Rotation Matrix)
7 Solution 6 (Angle Bisector)
8 Solution 7 (Complex Numbers)
9 Solution 8 (quick)
10 See Also
Problem
...
\[BX = 20 \tan{\angle{XPB}} = 20 \cdot \frac{1 - 3/5}{1 + 3/5} = 5\]

by tangent addition formula. Since $BX$ is 5 and the sidelength of the square is 20 the answer is $20 - 5 \implies \boxed{\textbf{B}}.$
Solution 4 (Cheap)
