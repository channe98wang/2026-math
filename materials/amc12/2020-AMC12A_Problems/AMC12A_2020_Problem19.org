...
6 Solution 5 (Psychology)
7 Video Solutions
7.1 Video Solution 1 (Simple)
7.2 Video Solution 2 (Richard Rusczyk)
7.3 Video Solution 3
7.4 Video Solution 4
7.5 Video Solution 5
8 See Also
Problem
...
Multiply both sides by $2^{17}+1$ to get

\[2^{289}+1=2^{a_1} + 2^{a_2} + … + 2^{a_k} + 2^{a_1+17} + 2^{a_2+17} + … + 2^{a_k+17}.\]
