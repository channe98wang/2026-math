...
Contents
1 Problem
2 Solution 1 (Graphical)
3 Solution 2 (Analytical)
4 Video Solution
5 See Also
Problem
...
- Since the center of $B$ is on one line of symmetry, $B$ contributes $2$ shaded unit squares to the resulting figure.
