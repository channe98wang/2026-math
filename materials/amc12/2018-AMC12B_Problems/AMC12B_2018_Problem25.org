...
4 Solution 3
5 Solution 4
6 Solution 5 (Pure Coordinate Bash)
7 Solution 6 (Trignometry Bash)
8 Solution 7
...
\[\left[P_1P_2P_3\right] = \frac{\sqrt 3}4\cdot\left(2\sqrt 3 + 2\sqrt 7\right)^2 = 10\sqrt 3 + 6\sqrt 7 = \sqrt{300} + \sqrt{252}.\]

So, our answer is $252 + 300 = \boxed{\textbf{D) }552}$ .
Note by diyarv:
...
\[8^2 = (x+4)^2 + (2x-4)^2 - 2(x+4)(2x-4)\cos 60^\circ,\]

which simplifies to $3x^2 - 12x - 16 = 0$ . The positive solution is $x = 2 + \tfrac23\sqrt{21}$ . Then $P_1P_2 = x\sqrt 3 = 2\sqrt 3 + 2\sqrt 7$ , and so the area of $\triangle P_1P_2P_3$ is

\[\frac{\sqrt 3}4\cdot\left(2\sqrt 3 + 2\sqrt 7\right)^2 = 10\sqrt 3 + 6\sqrt 7 = \sqrt{300} + \sqrt{252}.\]

The requested sum is $300 + 252 = \boxed{552}$ .
Solution 3
