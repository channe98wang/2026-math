...
7 Solution 6
8 Solution 7
9 Solution 8 (only if you don't have time)
10 Video Solution by Omega Learn
...
- There are $2$ possibilities for $A\equiv0\pmod3,$ namely $A=6,9.$
- There are $3$ possibilities for $B\equiv0\pmod3,$ namely $B=0,6,9.$
- There are $1$ possibility for $C\equiv0\pmod3,$ namely $C=9.$
