...
3 Solution 2 (Inequalities)
4 Solution 3 (Quick)
5 Solution 4 (Answer Choices)
6 Solution 5 (Answer Choices)
7 Solution 6 (Very Rigorous)
8 Video Solution 1
9 Video Solution 2
10 Video Solution 3
11 See Also
...
\[n\geq323d>323^2>100^2=10000,\]

which contradicts the precondition that $n$ is a $4$ -digit number.
...
\[n=\operatorname{lcm}(323,d)=17\cdot19\cdot20=6460.\]
