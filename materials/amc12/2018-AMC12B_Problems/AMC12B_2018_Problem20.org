...
11 Solution 9 (Midsegment Theorem)
11.1 Lemma 1:  is midsegment of .
11.2 Lemma 2:
11.3 Lemma 3:
11.4 Lemma 4:
11.5 Final step:
...
\[\frac{9\sqrt{3}}{16}-\frac{3\sqrt{3}}{32}=\boxed{\textbf{(C)}\ \frac {15}{32}\sqrt{3}}.\]
...
\[[APM]=[CQN]=[ERO]=\frac{1}{2} \cdot AP \cdot PM = \frac{1}{2} \cdot \frac{\sqrt{3}}{4} \cdot \frac{3}{4} = \frac{3 \sqrt{3}}{32}.\]
...
[asy] unitsize(1cm); draw((0,0)--(4,0)--(6,3.464)--(2,3.464)--(0,0)); draw((2,0)--(1,1.732)); draw((5,1.732)--(4,3.464)); draw((1.5, 0.866)--(3, 3.464)--(4.5, 0.866)--cycle); draw((2,0)--(2,3.464)--(5,1.732)--cycle); [/asy]
