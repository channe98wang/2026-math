...
1 Problem
2 Solution 1
3 Solution 2 (basically solution 3 but with steps and a quicker conclusion)
4 Solution 3
5 Solution 4
6 See also
Problem
...
Solution 1
By the change of base formula, $a_n = \frac{1}{\frac{\log 2002}{\log n}} = \left(\frac{1}{\log 2002}\right) \log n$ . Thus 
...
Note that . Therefore, . For the sake of space and time, set . Then can be represented as
