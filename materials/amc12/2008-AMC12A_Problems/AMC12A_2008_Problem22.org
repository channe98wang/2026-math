...
3 Solution 2 (without trigonometry)
4 Solution 3 (simply Pythagorean Theorem)
5 Solution 4
6 Solution 5 (coordinate bashing)
7 Solution 6
8 Solution 7 (Answer Choices & Estimation)
9 See Also
Problem
...
\[(2+\sqrt{3}x)^2 + x^2 = 8^2 \Rightarrow 4 + 3x^2 + 4\sqrt{3}x + x^2 = 64 \Rightarrow x^2 + \sqrt{3}x - 15 = 0\]

Using the quadratic formula to solve, we get

\[x = \frac{-\sqrt{3} \pm \sqrt{3 -4(1)(-15)}}{2} = \frac{\pm 3\sqrt{7} - \sqrt{3}}{2}\]
